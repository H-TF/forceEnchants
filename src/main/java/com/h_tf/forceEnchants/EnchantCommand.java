        ...
        if (strings.length == 0 || strings[0].equals("help")) {
            ...
            if (strings.length == 2 || strings.length == 3) {
                if (nbti.toString().contains(replace)) {
                    ...
                    String enchjson = Util.stringAppend(json, replace, value);
                    if (enchjson.equals("Err")) {
                    ...
                    String enchjson = Util.stringCreateEnch(json, replace, value);
                    if (enchjson.equals("Err")) {
                    ...
                    String enchjson = Util.createTag(json, replace, value);
                    if (enchjson.equals("Err")) {
